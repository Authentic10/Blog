...
<c:choose>
    <c:when test="${form.queryResult == 'no' }">
	 ...
	 <c:when test="${form.queryResult == 'ci' }">
		<script>
			$(document).ready(function () {
				$('.msg_error').addClass("alert alert-success");
				$('.msg_error').text(" Please, complete yout profile and continue ! ");
				$('.msg_error').show();
			});
		</script>
	</c:when>
...
<div class="container">
	...
	<br/>
	<h3 align="center">Complete profile</h3> <br/>
	<div class="d-flex justify-content-center">
		<form action="completeProfile" method="post" id="form_profile" enctype="multipart/form-data">
		<div class="form-group" >
			<div class="image-upload text-center">
			  <label for="img">
			    <img src="PICTURES/no-profile-picture.jpg" class="rounded-circle img-fluid" id="profile" width="120" height="110"/>
			  </label>
		  ...
		  <div class="row">
		  	 <div class="col">
			    ...
			    <input type="text" class="form-control" id="firstname" name="firstname" placeholder="xyz" value='<c:out value="${form.firstname }"/>'>
			  </div>
			  <div class="col">
			    <label for="lastname">Lastname *</label>
			    <input type="text" class="form-control" id="lastname" name="lastname" placeholder="abc" value='<c:out value="${form.lastname }"/>'>
			  </div>
		  </div><br>
		  <div class="form-group">
		    <label for="biography">Biography</label>
		    <textarea class="form-control" id="biography" name="biography" rows="3" ><c:out value="${form.biography }"/></textarea>
		  </div>
